...
const COMMANDS = {
  ...
  about: () => [
    ...
    { text: '│' },
    { text: "│  Développeur Full Stack passionné, autodidacte" },
    { text: "│  depuis 2020. Bac+4 Full Stack terminé ✓", color: 'green' },
    { text: '│' },
    { text: '│  Prochaine étape : Bac+5 Cybersécurité 🎯' },
    { text: '│' },
    { text: '│  Gaming : League of Legends · Cyberpunk 2077 · Spider-Man' },
    { text: '│  Manga  : One Piece · Berserk · Vagabond · Jujutsu Kaisen · Dandadan' },
    { text: '│' },
    { text: '└─────────────────────────────────────────────────────', color: 'cyan' },
  ],
