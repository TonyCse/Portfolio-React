...
const DECOS = [
  { e: '🌲', x: 0.03, y: 0.04 }, { e: '🌲', x: 0.97, y: 0.04 },
  { e: '🌲', x: 0.03, y: 0.90 }, { e: '🌲', x: 0.97, y: 0.90 },
  { e: '🌲', x: 0.50, y: 0.04 }, { e: '🌲', x: 0.50, y: 0.92 },
  { e: '🌲', x: 0.03, y: 0.46 }, { e: '🌲', x: 0.97, y: 0.46 },
  { e: '🌲', x: 0.20, y: 0.04 }, { e: '🌲', x: 0.65, y: 0.04 },
  { e: '🌲', x: 0.87, y: 0.04 }, { e: '🌲', x: 0.14, y: 0.88 },
  { e: '🌿', x: 0.18, y: 0.32 }, { e: '🌿', x: 0.42, y: 0.26 },
  { e: '🌿', x: 0.67, y: 0.35 }, { e: '🌿', x: 0.90, y: 0.30 },
  { e: '🌿', x: 0.15, y: 0.60 }, { e: '🌿', x: 0.40, y: 0.60 },
  { e: '🌿', x: 0.68, y: 0.62 }, { e: '🌿', x: 0.93, y: 0.62 },
  { e: '🍄', x: 0.42, y: 0.46 }, { e: '🍄', x: 0.68, y: 0.54 },
  { e: '🍄', x: 0.19, y: 0.86 }, { e: '🍄', x: 0.78, y: 0.88 },
  { e: '🌸', x: 0.37, y: 0.36 }, { e: '🌸', x: 0.72, y: 0.62 },
  { e: '🌸', x: 0.10, y: 0.30 }, { e: '🌳', x: 0.04, y: 0.66 },
  { e: '🌳', x: 0.04, y: 0.82 }, { e: '🌳', x: 0.14, y: 0.64 },
]
